...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='kdapUsMonthGrp2',WORKFLOW_ID='8fdc292bdd23400fbe99fadcc9e8f773', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-kdapUsMonthGrp2-0.4.dev.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('8fdc292bdd23400fbe99fadcc9e8f773')
    ...
    Complete = COMMON.getICISCompleteWflowTask('8fdc292bdd23400fbe99fadcc9e8f773')
