...
with COMMON.getICISDAG({
    'dag_id':'icis-rater-batch-rds-0.1.dev.0.0',
    ...
    authCheck = getICISAuthCheckWflow('a60576fdbdb44a918c0ed6a19db0bc02')
    ...
    rdsSetlJob = COMMON.getICISKubernetesPodOperator({
        'id' : 'de2a121d57a344e0a6f3fcf3e73ee8a3',
        'volumes': rdsSetlJob_vol,
        'volume_mounts': rdsSetlJob_volMnt,
        'env_from':rdsSetlJob_env,
        'task_id':'rdsSetlJob',
        'image':'nexus.dspace.kt.co.kr/icis/icis-rater-batch-rds:20230907175603',
        'arguments':["--job.names=rdsSetlJob" , "billMonth=202312"]
    })


    Complete = getICISCompleteWflowTask('a60576fdbdb44a918c0ed6a19db0bc02')
