...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='regression_verifying',WORKFLOW_ID='e6938cba26e143daad62fa814025f5ef', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-regression_verifying-0.5.dev.5.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('e6938cba26e143daad62fa814025f5ef')
    ...
    regressionVerifyingJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'a6b33bf30d0c4e17951dcf29327a2055',
    ...
    Complete = COMMON.getICISCompleteWflowTask('e6938cba26e143daad62fa814025f5ef')
