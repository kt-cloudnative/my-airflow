...
with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-cvdsbl-0.1.dev.3.3',
    ...
    authCheck = getICISAuthCheckWflow('017ba331e8344478820723aae648c8b6')
    ...
    lastItgFileCretJob = COMMON.getICISKubernetesPodOperator({
        'id' : 'efd0b5764ca14af0abbba4ece2ca5fc0',
    ...
    otcomCvNpfaCretJob = COMMON.getICISKubernetesPodOperator({
        'id' : '023e1ed25af9443e8bdd1532742f9389',
    ...
    Complete = getICISCompleteWflowTask('017ba331e8344478820723aae648c8b6')
