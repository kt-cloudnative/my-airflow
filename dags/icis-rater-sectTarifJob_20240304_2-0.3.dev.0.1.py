...
with COMMON.getICISDAG({
    'dag_id':'icis-rater-sectTarifJob_20240304_2-0.3.dev.0.1',
    ...
    authCheck = getICISAuthCheckWflow('86be11f6a540425a929d8334cac702c4')
    ...
    sectTarifJob = COMMON.getICISKubernetesPodOperator({
        'id' : 'b61ded3a54a548bcab110f57b8494b84',
    ...
    Complete = getICISCompleteWflowTask('86be11f6a540425a929d8334cac702c4')
