...
with COMMON.getICISDAG({
    'dag_id':'icis-rater-dscsTarifJob_20240305_1-0.3.dev.0.0',
    ...
    authCheck = getICISAuthCheckWflow('fd9b106cb60648b9929c325579567c8f')
    ...
    dscsTarifJob = COMMON.getICISKubernetesPodOperator({
        'id' : '130f5ad80e0e4ffe93342184db5b0a3f',
    ...
    Complete = getICISCompleteWflowTask('fd9b106cb60648b9929c325579567c8f')
