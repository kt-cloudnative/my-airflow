...
with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-cvrepno-0.2.dev.0.0',
    ...
    authCheck = getICISAuthCheckWflow('edbd5ed894824df5af06d362563596f7')
    ...
    CvRepNoWrlinCvFileCretJob = COMMON.getICISKubernetesPodOperator({
        'id' : 'f2b3c5910e4c482a93c410521371dec0',
        ...
        'image':'nexus.dspace.kt.co.kr/icis/icis-rater-batch-cvrepno:20230919140412',
        'arguments':["--job.names=cvRepNoWrlinJob","useYm=202307"]
    })


    Complete = getICISCompleteWflowTask('edbd5ed894824df5af06d362563596f7')
