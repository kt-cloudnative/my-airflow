...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='icis-rater-batch-edi-calsumbill',WORKFLOW_ID='2a839d63f0b34061a258e71315c7c91c', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-edi-calsumbill-0.4.dev.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('2a839d63f0b34061a258e71315c7c91c')
    ...
    ediCalsumBillJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '37e34f682371404b8498cb453fc92480',
    ...
    Complete = COMMON.getICISCompleteWflowTask('2a839d63f0b34061a258e71315c7c91c')
