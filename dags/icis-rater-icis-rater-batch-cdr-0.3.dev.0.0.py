...
with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-cdr-0.3.dev.0.0',
    ...
    authCheck = getICISAuthCheckWflow('4d8fedc4e7a845f5aaeecf147304e81f')
    ...
    ldinCdrJob = COMMON.getICISKubernetesPodOperator({
        'id' : 'aa567e9e290c42d7921be652dfb5fc35',
        'volumes': ldinCdrJob_vol,
        'volume_mounts': ldinCdrJob_volMnt,
        'env_from':ldinCdrJob_env,
        'task_id':'ldinCdrJob',
        'image':'nexus.dspace.kt.co.kr/icis/icis-rater-batch-cdr:20240112142301',
    ...
    drotCdrJob = COMMON.getICISKubernetesPodOperator({
        'id' : 'b2c5d6b332104d84b67057afbed7a805',
    ...
    cdrCretJob = COMMON.getICISKubernetesPodOperator({
        'id' : '39de0f3c2b81477896df4a86be096117',
    ...
    Complete = getICISCompleteWflowTask('4d8fedc4e7a845f5aaeecf147304e81f')
