...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='icis-rater-batch-lmtchk',WORKFLOW_ID='404f3219057e4dfd9254b1bc0812a61c', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-lmtchk-0.4.dev.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('404f3219057e4dfd9254b1bc0812a61c')
    ...
    lmtAmtFileCretJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'd7257667c1394cf8b38145f8dcb374bd',
        ...
        'image':'/icis/icis-rater-batch-lmtchk:20240801175910',
    ...
    Complete = COMMON.getICISCompleteWflowTask('404f3219057e4dfd9254b1bc0812a61c')
