...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='icis-rater-batch-cvcc-dev',WORKFLOW_ID='bef756afdd0f4d479ab53b85726252a8', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-cvcc-dev-0.4.dev.1.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('bef756afdd0f4d479ab53b85726252a8')
    ...
    intlCcVoipCvJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'dd0e3aee3f584e0aafc199053147c396',
        ...
        'arguments':["--job.names=intlCcVoipCvJob", "runType=T", "cyclYm=202403"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('bef756afdd0f4d479ab53b85726252a8')
