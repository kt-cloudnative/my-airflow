...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='regression_testing',WORKFLOW_ID='5bcfe06d4ecf42c68fc9cd1856005dc7', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-regression_testing-0.5.dev.3.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('5bcfe06d4ecf42c68fc9cd1856005dc7')
    ...
    regressionTestingJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '33b06a775be54fae8d6838b58ab21e7d',
    ...
    Complete = COMMON.getICISCompleteWflowTask('5bcfe06d4ecf42c68fc9cd1856005dc7')
