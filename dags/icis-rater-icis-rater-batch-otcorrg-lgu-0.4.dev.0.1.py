...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='icis-rater-batch-otcorrg-lgu',WORKFLOW_ID='d291894960fd430e8c248428d55812a1', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-otcorrg-lgu-0.4.dev.0.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('d291894960fd430e8c248428d55812a1')
    ...
    lgBfacSelJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '3091e89b7489469ca985c0cc324cafe8',
    ...
    Complete = COMMON.getICISCompleteWflowTask('d291894960fd430e8c248428d55812a1')
