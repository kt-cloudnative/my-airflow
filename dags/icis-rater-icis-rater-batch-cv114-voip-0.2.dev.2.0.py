...
with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-cv114-voip-0.2.dev.2.0',
    ...
    authCheck = getICISAuthCheckWflow('e27a9027f68a4949b8476034e52bc2f8')
    ...
    cv114VoIPJob = COMMON.getICISKubernetesPodOperator({
        'id' : '15356a8250d34c18b8bd886e3cff3167',
    ...
    Complete = getICISCompleteWflowTask('e27a9027f68a4949b8476034e52bc2f8')
