...
with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-cv114-wless-0.2.dev.0.0',
    ...
    authCheck = getICISAuthCheckWflow('9020c60ff50348b3a97f223e6bcdce95')
    ...
    cv114WlessJob = COMMON.getICISKubernetesPodOperator({
        'id' : 'adaaa5018f8e4615ae836bd3042f6ce4',
        ...
        'arguments':["--job.names=cv114WlessJob", "runType=T", "useYm=202306"]
    })


    Complete = getICISCompleteWflowTask('9020c60ff50348b3a97f223e6bcdce95')
