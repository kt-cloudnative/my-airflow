...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='smart_20240710',WORKFLOW_ID='a8a29218487a4580b358336269923085', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-smart_20240710-0.4.dev.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('a8a29218487a4580b358336269923085')
    ...
    sectTarifJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '7b143a270d8b49bcbcef5db1800a5f27',
    ...
    Complete = COMMON.getICISCompleteWflowTask('a8a29218487a4580b358336269923085')
