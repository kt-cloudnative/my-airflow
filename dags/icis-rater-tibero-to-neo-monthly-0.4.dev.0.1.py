...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='tibero-to-neo-monthly',WORKFLOW_ID='5f72522b6a8a46298d3a10146fc20ef9', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-tibero-to-neo-monthly-0.4.dev.0.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('5f72522b6a8a46298d3a10146fc20ef9')
    ...
    tiberoToNeoJob_001 = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '8f0256a11fc24331bdb4cf2edea2a63d',
    ...
    Complete = COMMON.getICISCompleteWflowTask('5f72522b6a8a46298d3a10146fc20ef9')
