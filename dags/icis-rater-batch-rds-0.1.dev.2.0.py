...
with COMMON.getICISDAG({
    'dag_id':'icis-rater-batch-rds-0.1.dev.2.0',
    ...
    authCheck = getICISAuthCheckWflow('678cfbef40c6406891ab5c5045c04f8f')
    ...
    rdsSetlJob = COMMON.getICISKubernetesPodOperator({
        'id' : '852f508a5c61402d94074bac5a55dd49',
    ...
    Complete = getICISCompleteWflowTask('678cfbef40c6406891ab5c5045c04f8f')
