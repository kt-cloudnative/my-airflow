...
with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-cdr-0.3.dev.2.0',
    ...
    authCheck = getICISAuthCheckWflow('4058f9386bf14987a2b21bc8b1e4cdd1')
    ...
    cdrCretJob = COMMON.getICISKubernetesPodOperator({
        'id' : '7f8cca20c64141a1bfa1489048651e5c',
        'volumes': cdrCretJob_vol,
        'volume_mounts': cdrCretJob_volMnt,
        'env_from':cdrCretJob_env,
        'task_id':'cdrCretJob',
        'image':'nexus.dspace.kt.co.kr/icis/icis-rater-batch-cdr:0.3.0.4',
    ...
    drotCdrJob = COMMON.getICISKubernetesPodOperator({
        'id' : '7b424c17736f46b5b5c25f96170a8551',
    ...
    ldinCdrJob = COMMON.getICISKubernetesPodOperator({
        'id' : '0ea1ab8d5b0f4230ab56b2ce3beb8510',
    ...
    Complete = getICISCompleteWflowTask('4058f9386bf14987a2b21bc8b1e4cdd1')
