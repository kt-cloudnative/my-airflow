...
with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-cvlftm-0.2.dev.2.0',
    ...
    authCheck = getICISAuthCheckWflow('7acc25806c0549618e01dd5e3068ffd1')
    ...
    cvLftmNoJob = COMMON.getICISKubernetesPodOperator({
        'id' : '9161eb2774e14075973776b7b010f551',
    ...
    Complete = getICISCompleteWflowTask('7acc25806c0549618e01dd5e3068ffd1')
