...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='icis-rater-batch-lmtchk',WORKFLOW_ID='62f5f221a9bd4d7881bfc5cc3a6da4b9', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-lmtchk-0.4.dev.4.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('62f5f221a9bd4d7881bfc5cc3a6da4b9')
    ...
    lmtAmtFileCretJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '72e223bf453c46d085cff44c27948435',
    ...
    Complete = COMMON.getICISCompleteWflowTask('62f5f221a9bd4d7881bfc5cc3a6da4b9')
