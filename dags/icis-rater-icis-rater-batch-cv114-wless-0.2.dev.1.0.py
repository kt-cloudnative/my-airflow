...
with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-cv114-wless-0.2.dev.1.0',
    ...
    authCheck = getICISAuthCheckWflow('ccd4948841df4c7f8c2b32a3b1cf1b08')
