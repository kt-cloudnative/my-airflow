...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='dscsTarifJob_07_20240828',WORKFLOW_ID='10246ed93b784220a84a162721ed89fb', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-dscsTarifJob_07_20240828-0.4.dev.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('10246ed93b784220a84a162721ed89fb')
    ...
    Complete = COMMON.getICISCompleteWflowTask('10246ed93b784220a84a162721ed89fb')
