...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='icis-rater-batch-voiprat',WORKFLOW_ID='cc35dff3eba44e559967f492c592c04e', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-voiprat-0.4.dev.3.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('cc35dff3eba44e559967f492c592c04e')
    ...
    missRoutJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '6b216d386362445e81aa21f4cce9a565',
    ...
    Complete = COMMON.getICISCompleteWflowTask('cc35dff3eba44e559967f492c592c04e')
