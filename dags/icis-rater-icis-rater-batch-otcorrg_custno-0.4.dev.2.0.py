...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='icis-rater-batch-otcorrg_custno',WORKFLOW_ID='b3f8630636d84cada9282d700f574958', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-otcorrg_custno-0.4.dev.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('b3f8630636d84cada9282d700f574958')
    ...
    otcWrlinCustNoDatCretJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '9e289d166908418eab69cd2e1b9ad41a',
        ...
        'image':'/icis/icis-rater-batch-otcorrg:20240805151818',
    ...
    Complete = COMMON.getICISCompleteWflowTask('b3f8630636d84cada9282d700f574958')
