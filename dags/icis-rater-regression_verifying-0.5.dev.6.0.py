...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='regression_verifying',WORKFLOW_ID='8981c366525e4807af7e5055b4b0f859', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-regression_verifying-0.5.dev.6.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('8981c366525e4807af7e5055b4b0f859')
    ...
    regressionVerifyingJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '311ee5756ef54c439774ae9705912518',
    ...
    Complete = COMMON.getICISCompleteWflowTask('8981c366525e4807af7e5055b4b0f859')
