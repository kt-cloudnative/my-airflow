...
with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-cvrepno-0.2.dev.1.1',
    ...
    authCheck = getICISAuthCheckWflow('1bc5760abeda4e55ae64f0315a3a4ff7')
    ...
    CvRepNoWrlinCvFileCretJob = COMMON.getICISKubernetesPodOperator({
        'id' : '4606de0d26764ae1824b817c270ea59c',
    ...
    Complete = getICISCompleteWflowTask('1bc5760abeda4e55ae64f0315a3a4ff7')
