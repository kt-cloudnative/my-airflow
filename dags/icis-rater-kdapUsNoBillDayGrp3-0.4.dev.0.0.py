...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='kdapUsNoBillDayGrp3',WORKFLOW_ID='1bff7cc26f574e4688cc8887a77d667d', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-kdapUsNoBillDayGrp3-0.4.dev.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('1bff7cc26f574e4688cc8887a77d667d')
    ...
    kdapUsNoBillJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'f8395b06c6bc4cfbb7f6b88fff811a6b',
        ...
        'arguments':["--job.names=kdapUsNoBillJob", "retvType=D", "cyclYm=20240901",  "cyclGroup=3"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('1bff7cc26f574e4688cc8887a77d667d')
