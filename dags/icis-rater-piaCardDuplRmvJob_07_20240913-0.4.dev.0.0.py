...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='piaCardDuplRmvJob_07_20240913',WORKFLOW_ID='aa47039e1f6541f5a4f673e18817bca9', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-piaCardDuplRmvJob_07_20240913-0.4.dev.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('aa47039e1f6541f5a4f673e18817bca9')
    ...
    piaCardDuplRmvJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'bd60fb7b53bf438bbf2eea17192ce65a',
        ...
        'image':'/icis/icis-rater-batch-card114:20240913142648',
    ...
    Complete = COMMON.getICISCompleteWflowTask('aa47039e1f6541f5a4f673e18817bca9')
