...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='icis-rater-batch-intltel-intlChage',WORKFLOW_ID='74dd5811a13d4772ae95e1c32d169971', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-intltel-intlChage-0.4.dev.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('74dd5811a13d4772ae95e1c32d169971')
    ...
    intlChageJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '6649f8abe9ad476287bedf5883413c0a',
    ...
    Complete = COMMON.getICISCompleteWflowTask('74dd5811a13d4772ae95e1c32d169971')
