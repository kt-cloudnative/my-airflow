...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='icis-rater-batch-lmtchk',WORKFLOW_ID='9bb9da8cc28442e0b40df47ce0c684b2', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-lmtchk-0.4.dev.6.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('9bb9da8cc28442e0b40df47ce0c684b2')
    ...
    lmtAmtExcsFileJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'e6e55ba0a8ab460797efb8eff709043f',
    ...
    Complete = COMMON.getICISCompleteWflowTask('9bb9da8cc28442e0b40df47ce0c684b2')
