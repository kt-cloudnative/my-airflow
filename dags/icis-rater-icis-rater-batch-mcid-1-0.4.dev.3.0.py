...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='icis-rater-batch-mcid-1',WORKFLOW_ID='ac9120fb2dfe489387ec5502317cfeb4', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-mcid-1-0.4.dev.3.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('ac9120fb2dfe489387ec5502317cfeb4')
    ...
    Complete = COMMON.getICISCompleteWflowTask('ac9120fb2dfe489387ec5502317cfeb4')
