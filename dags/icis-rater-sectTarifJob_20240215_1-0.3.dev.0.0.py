...
with COMMON.getICISDAG({
    'dag_id':'icis-rater-sectTarifJob_20240215_1-0.3.dev.0.0',
    ...
    authCheck = getICISAuthCheckWflow('57b02e47bb12495e9ee538fe0d2702b6')
    ...
    sectTarifJob = COMMON.getICISKubernetesPodOperator({
        'id' : '629b0176b7a84d3ead2898bb6855dd66',
    ...
    Complete = getICISCompleteWflowTask('57b02e47bb12495e9ee538fe0d2702b6')
