...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='icis-rater-batch-otcorrg-DA',WORKFLOW_ID='2efe1b2323fc4375bce69cfccad76720', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-otcorrg-DA-0.4.dev.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('2efe1b2323fc4375bce69cfccad76720')
    ...
    bfacSelOrrgCretJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'cb893c4981c44172a4c11f097c8323b8',
        ...
        'arguments':["--job.names=bfacSelOrrgCretJob", "cyclYm=202301", "otcomDiv=H"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('2efe1b2323fc4375bce69cfccad76720')
