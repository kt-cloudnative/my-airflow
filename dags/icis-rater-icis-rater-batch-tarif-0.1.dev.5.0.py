...
with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-tarif-0.1.dev.5.0',
    ...
    authCheck = getICISAuthCheckWflow('787e7ba037284e8c8b066419d252adf6')

    l2SmsTarifJob_vol = []
    l2SmsTarifJob_volMnt = []
    l2SmsTarifJob_vol.append(getVolume('t-rater-bat-pvc','t-rater-bat-pvc'))
    l2SmsTarifJob_volMnt.append(getVolumeMount('t-rater-bat-pvc',''))
    ...
    l2SmsTarifJob = COMMON.getICISKubernetesPodOperator({
        'id' : '5f71678be36640a388c7fb5134033638',
    ...
    Complete = getICISCompleteWflowTask('787e7ba037284e8c8b066419d252adf6')
