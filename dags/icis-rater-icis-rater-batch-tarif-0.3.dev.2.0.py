...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='icis-rater-batch-tarif',WORKFLOW_ID='af7486d67e7d483eaaae2214ca8b3643', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-tarif-0.3.dev.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('af7486d67e7d483eaaae2214ca8b3643')
    ...
    l7McidTarifJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'a0d16234190c445da8c64f89714edc2e',
        'volumes': l7McidTarifJob_vol,
        'volume_mounts': l7McidTarifJob_volMnt,
        'env_from':l7McidTarifJob_env,
        'task_id':'l7McidTarifJob',
        'image':'/icis/icis-rater-batch-tarif:20240613110429',
        'arguments':["--job.names=l7McidTarifJob","runType=T", "cyclYm=202402"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('af7486d67e7d483eaaae2214ca8b3643')
