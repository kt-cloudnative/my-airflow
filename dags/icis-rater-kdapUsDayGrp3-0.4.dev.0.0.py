...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='kdapUsDayGrp3',WORKFLOW_ID='ecdbf0637fc44b6e96f0df2ec641fd66', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-kdapUsDayGrp3-0.4.dev.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('ecdbf0637fc44b6e96f0df2ec641fd66')
    ...
    Complete = COMMON.getICISCompleteWflowTask('ecdbf0637fc44b6e96f0df2ec641fd66')
