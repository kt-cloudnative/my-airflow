...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='sectTarifJob_20240304_2',WORKFLOW_ID='c9c717f938644e47a1965648a8a16fa9', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-sectTarifJob_20240304_2-0.3.dev.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('c9c717f938644e47a1965648a8a16fa9')
    ...
    sectTarifJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '80800402d1704a3cbbd18c4cef5285dc',
    ...
    Complete = COMMON.getICISCompleteWflowTask('c9c717f938644e47a1965648a8a16fa9')
