...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='sectTarif_202410_v4',WORKFLOW_ID='1dbdfd2e56d9415a8796520895a7a1ad', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-sectTarif_202410_v4-0.4.dev.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('1dbdfd2e56d9415a8796520895a7a1ad')
    ...
    Complete = COMMON.getICISCompleteWflowTask('1dbdfd2e56d9415a8796520895a7a1ad')
