...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='sectTarif_202410_v3',WORKFLOW_ID='816c36854b7c4445a7bab7eb2fa20923', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-sectTarif_202410_v3-0.4.dev.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('816c36854b7c4445a7bab7eb2fa20923')
    ...
    sectTarifJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'f6e3f09f1ac44ab1866bf05e2dd56518',
    ...
    Complete = COMMON.getICISCompleteWflowTask('816c36854b7c4445a7bab7eb2fa20923')
