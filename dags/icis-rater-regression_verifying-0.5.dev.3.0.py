...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='regression_verifying',WORKFLOW_ID='57f4052551814e9cb651510f9a42a2e5', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-regression_verifying-0.5.dev.3.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('57f4052551814e9cb651510f9a42a2e5')
    ...
    regressionVerifyingJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '2607e462aa4849c1a347069e9ba6259f',
        ...
        'image':'/icis/icis-rater-engine-regression-testing:20241205172337',
    ...
    Complete = COMMON.getICISCompleteWflowTask('57f4052551814e9cb651510f9a42a2e5')
