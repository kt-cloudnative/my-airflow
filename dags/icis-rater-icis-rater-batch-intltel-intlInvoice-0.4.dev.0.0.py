...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='icis-rater-batch-intltel-intlInvoice',WORKFLOW_ID='935a6cdbf9c640f2b55661439361ba9f', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-intltel-intlInvoice-0.4.dev.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('935a6cdbf9c640f2b55661439361ba9f')
    ...
    invoiceJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '85744c1900484213bb2b2cf3a12f809b',
    ...
    Complete = COMMON.getICISCompleteWflowTask('935a6cdbf9c640f2b55661439361ba9f')
