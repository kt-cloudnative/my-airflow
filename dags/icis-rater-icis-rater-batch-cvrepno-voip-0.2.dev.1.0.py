...
with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-cvrepno-voip-0.2.dev.1.0',
    ...
    authCheck = getICISAuthCheckWflow('4cd043cc4fbe4770ba722ccf45fa630b')
    ...
    cvRepNoVoIPJob = COMMON.getICISKubernetesPodOperator({
        'id' : 'eb784b103f22431383ec2f7e4def9332',
    ...
    Complete = getICISCompleteWflowTask('4cd043cc4fbe4770ba722ccf45fa630b')
