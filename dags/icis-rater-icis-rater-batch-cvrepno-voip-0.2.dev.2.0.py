...
with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-cvrepno-voip-0.2.dev.2.0',
    ...
    authCheck = getICISAuthCheckWflow('eb79946ba6fd4f0280561da78832980d')
    ...
    cvRepNoVoIPJob = COMMON.getICISKubernetesPodOperator({
        'id' : '61ffb22abcea47c2a65d931f8200fc99',
    ...
    Complete = getICISCompleteWflowTask('eb79946ba6fd4f0280561da78832980d')
