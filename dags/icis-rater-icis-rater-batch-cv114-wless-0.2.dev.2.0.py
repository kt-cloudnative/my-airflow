...
with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-cv114-wless-0.2.dev.2.0',
    ...
    authCheck = getICISAuthCheckWflow('51624d524882455eb048ad6e145fe550')
    ...
    cv114WlessJob = COMMON.getICISKubernetesPodOperator({
        'id' : 'e07c0bdd53ce46efacc7a0f8f42980ff',
    ...
    Complete = getICISCompleteWflowTask('51624d524882455eb048ad6e145fe550')
