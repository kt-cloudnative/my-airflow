...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='dscsTarifJob_07_20240828',WORKFLOW_ID='1700e5e08c50446182b048f6751a6381', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-dscsTarifJob_07_20240828-0.4.dev.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('1700e5e08c50446182b048f6751a6381')
    ...
    dscsTarifJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '745c6d374e134591b1ffe512b3987c20',
    ...
    Complete = COMMON.getICISCompleteWflowTask('1700e5e08c50446182b048f6751a6381')
