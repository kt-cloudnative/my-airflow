...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='cv114_wrlin',WORKFLOW_ID='f7211b1bc50a4e55b2b95b928524d79c', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-cv114_wrlin-0.4.dev.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('f7211b1bc50a4e55b2b95b928524d79c')
    ...
    cv114WrlinJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'a0b0597585e04692902cbaba502a57b8',
        'volumes': cv114WrlinJob_vol,
        'volume_mounts': cv114WrlinJob_volMnt,
        'env_from':cv114WrlinJob_env,
        'task_id':'cv114WrlinJob',
        'image':'/icis/icis-rater-batch-cv114:20240311151246',
        'arguments':["--job.names=cv114WrlinJob", "runType=T", "cyclYm=202403"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('f7211b1bc50a4e55b2b95b928524d79c')
