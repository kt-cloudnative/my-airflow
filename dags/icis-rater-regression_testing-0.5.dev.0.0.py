...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='regression_testing',WORKFLOW_ID='6d9b721db906438f86671f463a1a52e1', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-regression_testing-0.5.dev.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('6d9b721db906438f86671f463a1a52e1')
    ...
    regressionTestingJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '5436a51ff5bd432a90f70d697212a54b',
        ...
        'arguments':["--job.names=testingJob", "cdrFileFmtId=L7", "fileId=4264243", "run.id=${YYYYMMDDHHMISS}"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('6d9b721db906438f86671f463a1a52e1')
