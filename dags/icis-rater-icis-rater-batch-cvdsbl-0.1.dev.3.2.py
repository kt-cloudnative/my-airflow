...
with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-cvdsbl-0.1.dev.3.2',
    ...
    authCheck = getICISAuthCheckWflow('d29af0083e79466aae05aa85441387e7')
    ...
    lastItgFileCretJob = COMMON.getICISKubernetesPodOperator({
        'id' : '16ae36daa4c84ac58e754e18361f1b8d',
    ...
    otcomCvNpfaCretJob = COMMON.getICISKubernetesPodOperator({
        'id' : '0c81a69d455246ac87bcb1dbd815dba8',
    ...
    Complete = getICISCompleteWflowTask('d29af0083e79466aae05aa85441387e7')
