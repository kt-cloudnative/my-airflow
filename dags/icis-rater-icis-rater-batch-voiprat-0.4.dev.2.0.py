...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='icis-rater-batch-voiprat',WORKFLOW_ID='f5361e0ce8554ef1a3a7852d914de584', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-voiprat-0.4.dev.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('f5361e0ce8554ef1a3a7852d914de584')
    ...
    missRoutJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'dd9e337ca56e4bbca4564dc8bfc4f72e',
        'volumes': missRoutJob_vol,
        'volume_mounts': missRoutJob_volMnt,
        'env_from':missRoutJob_env,
        'task_id':'missRoutJob',
        'image':'/icis/icis-rater-batch-voiprat:20241209110638',
    ...
    Complete = COMMON.getICISCompleteWflowTask('f5361e0ce8554ef1a3a7852d914de584')
