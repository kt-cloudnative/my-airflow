...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='regression_testing',WORKFLOW_ID='07172ca84c744603b73c55fbc3821813', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-regression_testing-0.5.dev.2.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('07172ca84c744603b73c55fbc3821813')
    ...
    regressionTestingJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '15d202d287ab47aead0df15564b4e354',
    ...
    Complete = COMMON.getICISCompleteWflowTask('07172ca84c744603b73c55fbc3821813')
