...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='regression_verifying',WORKFLOW_ID='3f55d7877ce143e4bcc0c2edc2781515', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-regression_verifying-0.5.dev.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('3f55d7877ce143e4bcc0c2edc2781515')
    ...
    regressionVerifyingJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '0f50f077c84948c180c0c609ccdf86a5',
    ...
    Complete = COMMON.getICISCompleteWflowTask('3f55d7877ce143e4bcc0c2edc2781515')
