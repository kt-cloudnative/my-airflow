...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='icis-rater-batch-voiprat',WORKFLOW_ID='c18d02a094d84bf683361a88f218dfb0', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-voiprat-0.4.dev.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('c18d02a094d84bf683361a88f218dfb0')
    ...
    missRoutJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '5ca99feb341e4ffa8ceafcb65f01c452',
        ...
        'arguments':["--job.names=missRoutJob", "cyclYm=202403"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('c18d02a094d84bf683361a88f218dfb0')
