...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='icis-rater-batch-cv1541-wlessBizr',WORKFLOW_ID='6672fe1624c24e21bd278f4773aae625', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-cv1541-wlessBizr-0.4.dev.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('6672fe1624c24e21bd278f4773aae625')
    ...
    wless1541CvTgtRegJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '9df78190ac4547548e1d32866e65511a',
        ...
        'arguments':["--job.names=chageNtcSmsJob", "cyclYm=202403"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('6672fe1624c24e21bd278f4773aae625')
