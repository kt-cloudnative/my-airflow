...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='eom',WORKFLOW_ID='1b86e17859d74f47bd7c2456d20a5856', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-eom-0.4.dev.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('1b86e17859d74f47bd7c2456d20a5856')
    ...
    eomMainJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '04f4125029ad437c890de3b4d94e2f70',
    ...
    Complete = COMMON.getICISCompleteWflowTask('1b86e17859d74f47bd7c2456d20a5856')
