...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='regression_testing',WORKFLOW_ID='a2983902633a431f993ec91f017bc984', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-regression_testing-0.5.dev.7.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('a2983902633a431f993ec91f017bc984')
    ...
    regressionTestingJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '12486bf633b4413184abe28eb0266301',
    ...
    Complete = COMMON.getICISCompleteWflowTask('a2983902633a431f993ec91f017bc984')
