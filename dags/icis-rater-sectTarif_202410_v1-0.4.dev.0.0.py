...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='sectTarif_202410_v1',WORKFLOW_ID='381ab7ba1ed343a2b7edaa27ae9a3e5b', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-sectTarif_202410_v1-0.4.dev.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('381ab7ba1ed343a2b7edaa27ae9a3e5b')
    ...
    sectTarifJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'ed3ba2f10e074414999e826c4bd52e94',
    ...
    Complete = COMMON.getICISCompleteWflowTask('381ab7ba1ed343a2b7edaa27ae9a3e5b')
