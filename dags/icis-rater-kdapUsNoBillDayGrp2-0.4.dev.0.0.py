...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='kdapUsNoBillDayGrp2',WORKFLOW_ID='4aa0b810b2cc49dfbf1717817893553a', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-kdapUsNoBillDayGrp2-0.4.dev.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('4aa0b810b2cc49dfbf1717817893553a')
    ...
    kdapUsNoBillJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '80cc0af22f0a4d4cbc99926a5cace0d1',
        ...
        'arguments':["--job.names=kdapUsNoBillJob", "retvType=D", "cyclYm=20240901",  "cyclGroup=2"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('4aa0b810b2cc49dfbf1717817893553a')
