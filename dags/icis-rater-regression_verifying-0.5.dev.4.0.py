...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='regression_verifying',WORKFLOW_ID='de4cc4ca0c514af987aa7ef2b5066dfa', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-regression_verifying-0.5.dev.4.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('de4cc4ca0c514af987aa7ef2b5066dfa')
    ...
    regressionVerifyingJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '2e3015c64a744c1680dfba4ec549c96e',
    ...
    Complete = COMMON.getICISCompleteWflowTask('de4cc4ca0c514af987aa7ef2b5066dfa')
