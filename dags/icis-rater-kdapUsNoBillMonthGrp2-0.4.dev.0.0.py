...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='kdapUsNoBillMonthGrp2',WORKFLOW_ID='00a309d225ff42f9a8211dbb929c4592', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-kdapUsNoBillMonthGrp2-0.4.dev.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('00a309d225ff42f9a8211dbb929c4592')
    ...
    kdapUsNoBillJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '365a2e7d02524c3a897a775ad73531c1',
        ...
        'arguments':["--job.names=kdapUsNoBillJob", "retvType=M", "cyclYm=202407",  "cyclGroup=2"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('00a309d225ff42f9a8211dbb929c4592')
