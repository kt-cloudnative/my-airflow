...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='eoc-work2',WORKFLOW_ID='33cb287df3584a0bbc96a7849952e4bc', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-eoc-work2-0.4.dev.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('33cb287df3584a0bbc96a7849952e4bc')
    ...
    eocMainJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '5dfcae495ef74e31ac9928dfccfb05d3',
        'volumes': eocMainJob_vol,
        'volume_mounts': eocMainJob_volMnt,
        'env_from':eocMainJob_env,
        'task_id':'eocMainJob',
        'image':'/icis/icis-rater-engine-eoc-batch:20240924140506',
    ...
    Complete = COMMON.getICISCompleteWflowTask('33cb287df3584a0bbc96a7849952e4bc')
