...
with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-tarif-0.1.dev.3.0',
    ...
    authCheck = getICISAuthCheckWflow('b770ddf17f744d8c9f172cf8b7c06dd0')
    ...
    l2SmsTarifJob = COMMON.getICISKubernetesPodOperator({
        'id' : '3cea3149ac3642c0905005b24bf1a7d3',
        'volumes': l2SmsTarifJob_vol,
        'volume_mounts': l2SmsTarifJob_volMnt,
        'env_from':l2SmsTarifJob_env,
        'task_id':'l2SmsTarifJob',
        'image':'nexus.dspace.kt.co.kr/icis/icis-rater-batch-tarif:20230920093700',
        'arguments':["--job.names=l2SmsTarifJob", "runType=T", "useYm=202306"]
    })


    Complete = getICISCompleteWflowTask('b770ddf17f744d8c9f172cf8b7c06dd0')
