...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='sectTarif_07_20240828',WORKFLOW_ID='408ce45265b946d9ba990bab12a0b1ab', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-sectTarif_07_20240828-0.4.dev.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('408ce45265b946d9ba990bab12a0b1ab')
    ...
    sectTarifJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '5917cd2f03984cddb935b48d3bbd0668',
    ...
    Complete = COMMON.getICISCompleteWflowTask('408ce45265b946d9ba990bab12a0b1ab')
