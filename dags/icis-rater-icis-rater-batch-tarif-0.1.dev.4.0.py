...
with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-tarif-0.1.dev.4.0',
    ...
    authCheck = getICISAuthCheckWflow('db6df18eb70f40afbcef88ea8ad763a8')
    ...
    l2SmsTarifJob = COMMON.getICISKubernetesPodOperator({
        'id' : 'e0f8d296f2f84a59bec3197352a07687',
    ...
    Complete = getICISCompleteWflowTask('db6df18eb70f40afbcef88ea8ad763a8')
