...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='icis-rater-batch-lmtchk',WORKFLOW_ID='7d6d430e30da4a2eb20425c3e7783bfd', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-lmtchk-0.4.dev.3.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('7d6d430e30da4a2eb20425c3e7783bfd')
    ...
    lmtAmtFileCretJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '72fb0229a06047088d01ddcefeb7f9ee',
        ...
        'image':'/icis/icis-rater-batch-lmtchk:20240802090041',
    ...
    Complete = COMMON.getICISCompleteWflowTask('7d6d430e30da4a2eb20425c3e7783bfd')
