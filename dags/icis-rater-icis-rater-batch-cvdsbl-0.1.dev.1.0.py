...
with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-cvdsbl-0.1.dev.1.0',
    ...
    authCheck = getICISAuthCheckWflow('4a2b4f07b17f4177a7300369669164e5')
    ...
    otcomCvNpfaCretJob = COMMON.getICISKubernetesPodOperator({
        'id' : '5905db9a0ac44f88a8b3ce61dd90d5f6',
    ...
    lastItgFileCretJob = COMMON.getICISKubernetesPodOperator({
        'id' : 'a141b91208e745dfb66d1e469aedb982',
        ...
        'image':'nexus.dspace.kt.co.kr/icis/icis-rater-batch-cvdsbl:0.1.1.2',
        'arguments':["--job.names=lastItgFileCretJob runType=T cyclYm=202306"]
    })


    Complete = getICISCompleteWflowTask('4a2b4f07b17f4177a7300369669164e5')
