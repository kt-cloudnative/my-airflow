...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='icis-rater-batch-cvdsbl-mycomDatLoadJob',WORKFLOW_ID='5b533d4310de4bf380fe9a7dda64ebc0', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-cvdsbl-mycomDatLoadJob-0.4.dev.0.1'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('5b533d4310de4bf380fe9a7dda64ebc0')
    ...
    mycomDatLoadJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'beaa685934f148bea6d10f54d6e5b6ef',
    ...
    Complete = COMMON.getICISCompleteWflowTask('5b533d4310de4bf380fe9a7dda64ebc0')
