...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='icis-rater-batch-otcorrg_custno',WORKFLOW_ID='a52e1d41e15041c480692baf785a16b8', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-otcorrg_custno-0.4.dev.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('a52e1d41e15041c480692baf785a16b8')
    ...
    otcWrlinCustNoDatCretJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : 'f189fb858b974676a709f52bf887817b',
        ...
        'image':'/icis/icis-rater-batch-otcorrg:20240805151521',
    ...
    Complete = COMMON.getICISCompleteWflowTask('a52e1d41e15041c480692baf785a16b8')
