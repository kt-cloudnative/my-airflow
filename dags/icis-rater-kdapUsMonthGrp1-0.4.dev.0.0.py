...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='kdapUsMonthGrp1',WORKFLOW_ID='9e3bb4980fb9419ab8f49d582978313c', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-kdapUsMonthGrp1-0.4.dev.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('9e3bb4980fb9419ab8f49d582978313c')
    ...
    Complete = COMMON.getICISCompleteWflowTask('9e3bb4980fb9419ab8f49d582978313c')
