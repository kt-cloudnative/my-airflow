...
with COMMON.getICISDAG({
    'dag_id':'icis-rater-sectTarifJob_20240306_1-0.3.dev.0.0',
    'schedule_interval':'@once',
    'start_date': datetime(2024, 3, 6, 0, 0, 00, tzinfo=local_tz),
    'end_date': None,
    'paused': True
})as dag:

    authCheck = getICISAuthCheckWflow('517ba1c1053c40ceac747e4139b654f2')
    ...
    sectTarifJob = COMMON.getICISKubernetesPodOperator({
        'id' : 'b6fef2cdcba943148c7febd349c58a68',
        'volumes': sectTarifJob_vol,
        'volume_mounts': sectTarifJob_volMnt,
        'env_from':sectTarifJob_env,
        'task_id':'sectTarifJob',
        'image':'nexus.dspace.kt.co.kr/icis/icis-rater-batch-smartmsg:20240306150011',
        'arguments':["--job.names=sectTarifJob", "runType=T", "cyclYm=202311"]
    })


    Complete = getICISCompleteWflowTask('517ba1c1053c40ceac747e4139b654f2')
