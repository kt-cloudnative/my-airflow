...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='regression_verifying',WORKFLOW_ID='bebbec1d96e349beb998e4f2502a9b6f', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-regression_verifying-0.5.dev.7.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('bebbec1d96e349beb998e4f2502a9b6f')
    ...
    regressionVerifyingJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '95bb5b0bc9b14d4a81c4aa97ef0f6f85',
        ...
        'image':'/icis/icis-rater-engine-regression-testing:20241210144904',
    ...
    Complete = COMMON.getICISCompleteWflowTask('bebbec1d96e349beb998e4f2502a9b6f')
