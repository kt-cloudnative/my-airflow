...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='icis_rater_rerate_steptarif_l2',WORKFLOW_ID='bea5ebb0224844879115cb82abc85e18', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis_rater_rerate_steptarif_l2-0.4.dev.0.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('bea5ebb0224844879115cb82abc85e18')
    ...
    stepTarifJob = COMMON.getICISKubernetesPodOperator_v1({
        'id' : '2ba7e5571abe402aa2120b096673394b',
        ...
        'arguments':["--job.names=stepTarifJob", "runType=T", "cyclYm=202410", "format=L2"],
    ...
    Complete = COMMON.getICISCompleteWflowTask('bea5ebb0224844879115cb82abc85e18')
