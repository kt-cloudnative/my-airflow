...
COMMON = ICISCmmn(DOMAIN='rater',ENV='dev', NAMESPACE='t-rater'
                , WORKFLOW_NAME='icis-rater-batch-posdata',WORKFLOW_ID='1191207da89340088a09c07f194596f2', APP_NAME='NBSS_TRAT', CHNL_TYPE='TR', USER_ID='91337910')

with COMMON.getICISDAG({
    'dag_id':'icis-rater-icis-rater-batch-posdata-0.4.dev.1.0'
    ...
    authCheck = COMMON.getICISAuthCheckWflow('1191207da89340088a09c07f194596f2')
    ...
    Complete = COMMON.getICISCompleteWflowTask('1191207da89340088a09c07f194596f2')
